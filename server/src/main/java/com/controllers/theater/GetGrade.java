...
public class GetGrade {
    ...
    @RequestMapping(value="theater/get_grades", method=RequestMethod.GET)
    public String getGrades() {
        return "this controller is for getting grades of a specific theater...";
    }
    
    @RequestMapping(value="theater/get_grades", method=RequestMethod.POST)
    public String getGrades(@RequestBody JSONObject jsonObj) {
    	...
    	try {
    		...
    		if (jsonObj.containsKey(Keyword.THEATER_ID)) {
    			...
    			String SQL = String.format("select user_id, value, content, date_time from theater_grade where theater_id = %d", jsonObj.getInt(Keyword.THEATER_ID));
