...
public class TheaterListActivity2 extends AppCompatActivity implements viewController, BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    private void initListView() {
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent it = new Intent(TheaterListActivity2.this, ChoosingProductActivity.class);
    ...
    public void updateView(String url, String response) {
        if (response == null) {
            Toast.makeText(TheaterListActivity2.this, "network fail", Toast.LENGTH_SHORT).show();
            return;
        }
